...
namespace Marmot::Materials {
  ...
  RtTsA::RtTsA( const double* materialProperties, int nMaterialProperties, int materialLabel )
    : MarmotMaterialFiniteStrain( materialProperties, nMaterialProperties, materialLabel ),
      ...
      Q1( materialProperties[3] ),
      Q2( materialProperties[4] ),
      b1( materialProperties[5] ),
      b2( materialProperties[6] ),
      b3( materialProperties[7] ),
      b4( materialProperties[8] ),
      b5( materialProperties[9] ),
      k0_dot( materialProperties[10] ),
      n( materialProperties[11] ),
      nu_plus( materialProperties[12] ),
      nu_minus( materialProperties[13] ),
      eta( materialProperties[14] ),
